               ...
               <Navbar.Collapse id="responsive-navbar-nav">
                  <Nav className="mr-auto">
                     ...
                     <NavDropdown
                        ...
                        className="centro-navbar-item centro-navbar-item-mobile"
                     >
                        <NavDropdown.Item className="centro-navbar-item centro-navbar-item-mobile" href="/#">
                           Hamburguesas
                        </NavDropdown.Item>
                        <NavDropdown.Item className="centro-navbar-item centro-navbar-item-mobile" href="/#">
                           Pollo Frito
                     ...
                     {/* <Nav.Link href="/rubros" className="centro-navbar-item centro-navbar-item-mobile">
                        Rubros
                     </Nav.Link> */}
                     <Link to={'/rubros'} className="centro-navbar-item centro-navbar-item-mobile">
                        Rubros
                     </Link>
                  </Nav>
               </Navbar.Collapse>
